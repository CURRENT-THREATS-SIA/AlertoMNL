...
geolocate.on('geolocate', (position) => {
  ...
  // Update accuracy circle radius based on actual accuracy
  if (accuracyCircle) {
    accuracyCircle.style.transform = \`scale(\${Math.min(accuracy / 10, 4)})\`;
  }
...
locationMarker.className = 'current-location-dot';
const accuracyCircle = document.createElement('div');
accuracyCircle.className = 'current-location-accuracy';
locationMarker.appendChild(accuracyCircle);
